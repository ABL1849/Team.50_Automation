...
import { FaEyeSlash, FaMehRollingEyes } from "react-icons/fa";
    ...
    <div className='w-full flex flex-col justify-center items-center gap-y-7 bg-black'>
      <div className='w-2/3'>
        <form onSubmit={submitHandler} className='flex w-full flex-col justify-center items-center gap-y-2 text-[#0ea5e9]'>
          ...
          <input name = 'email' value={hrFormData.email} onChange={changeHandler} type="email" id='email' className='text-[#8e898e] w-full py-2 rounded-lg outline-none  focus:border-none px-4 text-lg bg-[#0e1628]'></input>
          ...
          <div className='w-full bg-[#0e1628] rounded-lg items-center text-xl pl-2 flex'>
            <input name = 'password' value={hrFormData.password} onChange={changeHandler} type={ privacy ? 'text' : 'password' } id='pwd' className='text-[#8e898e] w-5/6 outline-none py-2 rounded-lg focus:border-none px-2 bg-[#0e1628]'></input>
            {
